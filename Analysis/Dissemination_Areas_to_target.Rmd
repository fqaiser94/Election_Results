...
# aggregating_sd_cleaned 
# this is a bit of a temporary hack
# I need all this informatio in geo_linkage.csv
aggregating_sd_cleaned <- aggregating_sd %>%
  left_join(select(election_results, Ward, Subdivision, AreaName), 
            c('Ward', 'Associated_Subdivision'='Subdivision')) %>%
  rename(Associated_AreaName = AreaName)
